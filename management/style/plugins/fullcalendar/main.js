...
var FullCalendar = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    var globalObj = typeof globalThis !== 'undefined' ? globalThis : window; // // : streamline when killing IE11 support
    ...
    var EventSourceApi = /** @class */ (function () {
        ...
        Object.defineProperty(EventSourceApi.prototype, "format", {
            get: function () {
                return this.internalEventSource.meta.format; // : bad. not guaranteed
            },
            enumerable: false,
            configurable: true
        });
    ...
    // accepts multiple subject els
    // only queries direct child elements // : rename to findDirectChildren!
    ...
    function computeSmallestCellWidth(cellEl) {
        ...
        if (!allWidthEl) {
            throw new Error('needs fc-scrollgrid-shrink-frame className'); // : use const
        }
        if (!contentWidthEl) {
    ...
    */
    ...
    function expandRecurring(eventStore, framingRange, context) {
        ...
        // : bad. always expand events as a second step
    ...
    */
    ...
    // : somehow merge with buildIsoString and stripZeroTime
    // : rename. omit "string"
    function formatDayString(marker) {
        return marker.toISOString().replace(/T.*$/, '');
    }
    // : use Date::toISOString and use everything after the T?
        ...
        function NativeFormatter(formatSettings) {
            ...
            for (var name_1 in formatSettings) {
                if (name_1 in EXTENDED_SETTINGS_AND_SEVERITIES) {
                    ...
                    if (name_1 in STANDARD_DATE_PROP_SEVERITIES) { // : what about hour12? no severity
    ...
    function formatWeekNumber(num, weekText, weekTextLong, locale, display) {
        ...
        if (locale.options.direction === 'rtl') { // : use control characters instead?
            parts.reverse();
        }
        return parts.join('');
    }
    ...
    */
    ...
    // : better called "EventSettings" or "EventConfig"
    // : move this file into structs
    // : separate constraint/overlap/allow, because selection uses only that, not other props
    ...
    */
    ...
    function buildEventRangeKey(eventRange) {
        ...
        // inverse-background events don't have specific instances. : better solution
    }
    ...
    */
    ...
    var EventApi = /** @class */ (function () {
        ...
        */
        ...
        EventApi.prototype.toPlainObject = function (settings) {
            ...
            // : what about recurring-event properties???
            // : include startEditable/durationEditable/constraint/overlap/allow
    ...
    function buildDateEnv$1(settings) {
        var locale = buildLocale(settings.locale || 'en', organizeRawLocales([]).map); // : don't hardcode 'en' everywhere
    ...
    */
    ...
    function computeCanVGrowWithinCell() {
        ...
        // : just make this logic execute top-level, immediately, instead of doing lazily
    ...
    */
    ...
    // : easier way to add new hooks? need to update a million things
    ...
    StandardTheme.prototype.iconOverrideOption = 'buttonIcons'; // : make TS-friendly
    ...
    // : rename to be about function, not default. use in above type
    ...
    function parseViewConfig(input) {
        ...
        if (rawOptions.content) {
            ...
            // : remove content/classNames/didMount/etc from options?
        }
        return {
            ...
            if ((customButtonProps = calendarCustomButtons[buttonName])) {
                buttonClick = function (ev) {
                    if (customButtonProps.click) {
                        customButtonProps.click.call(ev.target, ev, ev.target); // : use Calendar this context?
                    }
                };
    ...
    */
        ...
        DelayedRunner.prototype.request = function (delay) {
            ...
            if (!this.isPaused()) {
                ...
                if (delay == null) {
                    ...
                    this.timeoutId = setTimeout(// NOT OPTIMAL! : look at debounce
    ...
    var CalendarDataManager = /** @class */ (function () {
        ...
        CalendarDataManager.prototype._handleAction = function (action) {
            ...
            if (action.type === 'PREV' || // : move this logic into DateProfileGenerator
                action.type === 'NEXT' || // "
        ...
        CalendarDataManager.prototype._computeOptionsData = function (optionOverrides, dynamicOptionOverrides, calendarApi) {
            // : blacklist options that are handled by optionChangeHandlers
    ...
    */
    ...
    var SegHierarchy = /** @class */ (function () {
        function SegHierarchy() {
            ...
            this.stackCnts = {}; // : use better technique!?
        }
    ...
    */
    ...
    // : get rid of this in favor of options system,
    ...
    */
    ...
    var CalendarContent = /** @class */ (function (_super) {
        ...
        */
        CalendarContent.prototype.render = function () {
            ...
            var toolbarProps = this.buildToolbarProps(props.viewSpec, props.dateProfile, props.dateProfileGenerator, props.currentDate, getNow(props.options.now, props.dateEnv), // : use NowTimer????
            props.viewTitle);
            var viewVGrow = false;
            var viewHeight = '';
            var viewAspectRatio;
    ...
    function buildToolbarProps(viewSpec, dateProfile, dateProfileGenerator, currentDate, now, title) {
        ...
        var todayInfo = dateProfileGenerator.build(now, undefined, false); // : need `undefined` or else INFINITE LOOP for some reason
    ...
    var TableDowCell = /** @class */ (function (_super) {
        ...
        TableDowCell.prototype.render = function () {
            ...
            var text = dateEnv.format(date, props.dayHeaderFormat);
            var hookProps = __assign(__assign(__assign(__assign({ // : make this public?
    ...
    */
    ...
    function isInteractionPropsValid(state, context, dateSpanMeta, filterConfig) {
        ...
        // exclude the subject events. : exclude defs too?
    ...
    var Scroller = /** @class */ (function (_super) {
        ...
        Scroller.prototype.getXScrollbarWidth = function () {
            ...
            return this.el.offsetHeight - this.el.clientHeight; // only works because we guarantee no borders. : add to CSS with important?
        };
        Scroller.prototype.getYScrollbarWidth = function () {
            if (VISIBLE_HIDDEN_RE.test(this.props.overflowY)) {
                return 0;
            }
            return this.el.offsetWidth - this.el.clientWidth; // only works because we guarantee no borders. : add to CSS with important?
        };
        return Scroller;
    }(BaseComponent));
    ...
    : infer RefType from masterCallback if provided
    */
    var RefMap = /** @class */ (function () {
        ...
        // : check callers that don't care about order. should use getAll instead
        // NOTE: this method has become less valuable now that we are encouraged to map order by some other index
        // : provide ONE array-export function, buildArray, which fails on non-numeric indexes. caller can manipulate and "collect"
    ...
    // : ONLY use `arg`. force out internal function to use same API
    ...
    function sanitizeShrinkWidth(shrinkWidth) {
        ...
        4 accounts for 2 2-pixel borders. : better solution? */
    ...
    var SimpleScrollGrid = /** @class */ (function (_super) {
        ...
        function SimpleScrollGrid() {
            ...
            // : can do a really simple print-view. dont need to join rows
        ...
        SimpleScrollGrid.prototype.renderChunkTd = function (sectionConfig, microColGroupNode, chunkConfig, isHeader) {
            ...
            var needsYScrolling = getAllowYScrolling(props, sectionConfig); // : do lazily. do in section config?
            var isLiquid = getSectionHasLiquidHeight(props, sectionConfig);
            // for `!props.liquid` - is WHOLE scrollgrid natural height?
            // : do same thing in advanced scrollgrid? prolly not b/c always has horizontal scrollbars
        ...
        SimpleScrollGrid.prototype.computeScrollerDims = function () {
            ...
            for (var _i = 0, _b = this.props.sections; _i < _b.length; _i++) {
                ...
                if (scrollerEl) {
                    var harnessEl = scrollerEl.parentNode; // : weird way to get this. need harness b/c doesn't include table borders
    ...
    var WeekNumberRoot = function (props) { return (createElement(ViewContextType.Consumer, null, function (context) {
        ...
        var num = dateEnv.computeWeekNumber(date); // : somehow use for formatting as well?
    ...
    var MorePopover = /** @class */ (function (_super) {
        ...
        MorePopover.prototype.render = function () {
            ...
            return (createElement(DayCellRoot, { date: startDate, dateProfile: dateProfile, todayRange: todayRange, elRef: this.handleRootEl }, function (rootElRef, dayClassNames, dataAttrs) { return (createElement(Popover, { elRef: rootElRef, id: props.id, title: title, extraClassNames: ['fc-more-popover'].concat(dayClassNames), extraAttrs: dataAttrs /* : make these time-based when not whole-day? */, parentEl: props.parentEl, alignmentEl: props.alignmentEl, alignGridTop: props.alignGridTop, onClose: props.onClose },
    ...
    var MoreLinkRoot = /** @class */ (function (_super) {
        ...
        MoreLinkRoot.prototype.render = function () {
            ...
            return (createElement(ViewContextType.Consumer, null, function (context) {
                ...
                var text = typeof moreLinkText === 'function' // : eventually use formatWithOrdinals
    ...
    */
    var FeaturefulElementDragging = /** @class */ (function (_super) {
        ...
        FeaturefulElementDragging.prototype.destroy = function () {
            ...
            // : fire 'dragend' directly and stop interaction. discourage use of pointerup event (b/c might not fire)
            this.onPointerUp({});
        };
        ...
        function HitDragging(dragging, droppableStore) {
            ...
            this.handlePointerDown = function (ev) {
                ...
                if (_this.initialHit || !_this.requireInitial) {
                    ...
                    // : fire this before computing processFirstCoord, so listeners can cancel. this gets fired by almost every handler :(
                    _this.emitter.trigger('pointerdown', ev);
                }
                else {
    ...
    var EventDragging = /** @class */ (function (_super) {
        ...
        function EventDragging(settings) {
            ...
            _this.handleHitUpdate = function (hit, isFinal) {
                ...
                if (!isFinal) {
                    if (initialContext === receivingContext && // : write test for this
        ...
        InferredElementDragging.prototype.setMirrorIsVisible = function (bool) {
            if (bool) {
                ...
                var mirrorEl = this.mirrorSelector
                    // : somehow query FullCalendars WITHIN shadow-roots
    ...
    */
    ...
    var TableView = /** @class */ (function (_super) {
        ...
        TableView.prototype.renderSimpleLayout = function (headerRowContent, bodyContent) {
            ...
            return (createElement(ViewRoot, { viewSpec: context.viewSpec }, function (rootElRef, classNames) { return (createElement("div", { ref: rootElRef, className: ['fc-daygrid'].concat(classNames).join(' ') },
                createElement(SimpleScrollGrid, { liquid: !props.isHeightAuto && !props.forPrint, collapsibleWidth: props.forPrint, cols: [] /* : make optional? */, sections: sections }))); }));
        };
    ...
    var TableRow = /** @class */ (function (_super) {
        ...
        TableRow.prototype.render = function () {
            ...
            var isForcedInvisible = // : messy way to compute this
            ...
            return (createElement("tr", { ref: this.rootElRef, role: "row" },
                ...
                props.cells.map(function (cell, col) {
                    ...
                    return (createElement(TableCell, { key: cell.key, elRef: _this.cellElRefs.createRef(cell.key), innerElRef: _this.frameElRefs.createRef(cell.key) /* FF <td> problem, but okay to use for left/right. : rename prop */, dateProfile: props.dateProfile, date: cell.date, showDayNumber: props.showDayNumbers, showWeekNumber: props.showWeekNumbers && col === 0, forceDayTop: props.showWeekNumbers /* even displaying weeknum for row, not necessarily day */, todayRange: props.todayRange, eventSelection: props.eventSelection, eventDrag: props.eventDrag, eventResize: props.eventResize, extraHookProps: cell.extraHookProps, extraDataAttrs: cell.extraDataAttrs, extraClassNames: cell.extraClassNames, extraDateSpan: cell.extraDateSpan, moreCnt: moreCnts[col], moreMarginTop: moreMarginTops[col], singlePlacements: singleColPlacements[col], fgContentElRef: _this.fgElRefs.createRef(cell.key), fgContent: ( // Fragment scopes the keys
        ...
        TableRow.prototype.renderFgSegs = function (col, segPlacements, todayRange, isForcedInvisible, isDragging, isResizing, isDateSelecting) {
            ...
            if (framePositions) {
                for (var _i = 0, segPlacements_1 = segPlacements; _i < segPlacements_1.length; _i++) {
                    ...
                    : in print view, for multi-day events, don't display title within non-start/end segs
                    */
        ...
        TableRow.prototype.updateSizing = function (isExternalSizingChange) {
            ...
            if (!props.forPrint &&
                ...
                this.setState({
                    ...
                    // : always display all events, as visibility:hidden?
    ...
    function buildMirrorPlacements(mirrorSegs, colPlacements) {
        ...
        var topsByInstanceId = buildAbsoluteTopHash(colPlacements); // : cache this at first render?
    ...
    var Table = /** @class */ (function (_super) {
        ...
        Table.prototype.render = function () {
            ...
            // : best place to normalize these options?
            ...
            return (createElement("div", { className: classNames.join(' '), ref: this.handleRootEl, style: {
                    ...
                    // : if we set it here, can we avoid giving to inner tables?
        ...
        Table.prototype.prepareHits = function () {
            this.rowPositions = new PositionCache(this.rootEl, this.rowRefs.collect().map(function (rowObj) { return rowObj.getCellEls()[0]; }), // first cell el in each row. : not optimal
            false, true);
        ...
        Table.prototype.getCellEl = function (row, col) {
            return this.rowRefs.currentMap[row].getCellEls()[col]; // : not optimal
        };
    ...
    function TimeColsAxisCell(props) {
        ...
        return (createElement(ViewContextType.Consumer, null, function (context) {
            ...
            var labelFormat = // : fully pre-parse
    ...
    var TimeColsView = /** @class */ (function (_super) {
        ...
        function TimeColsView() {
            ...
            _this.handleScrollTopRequest = function (scrollTop) {
                ...
                if (scrollerEl) { // : not sure how this could ever be null. weirdness with the reducer
            ...
            _this.renderTableRowAxis = function (rowHeight) {
                ...
                return (
                // : make reusable hook. used in list view too
        ...
        TimeColsView.prototype.renderSimpleLayout = function (headerRowContent, allDayContent, timeContent) {
            ...
            if (allDayContent) {
                ...
                sections.push({
                    type: 'body',
                    key: 'all-day-divider',
                    outerContent: ( // : rename to cellContent so don't need to define <tr>?
                ...
                chunks: [
                    {
                        ...
                        // : make this now-indicator arrow more DRY with TimeColsContent
    ...
    */
    ...
    function webToRects(topLevelNodes) {
        ...
        return rects; // : sort rects by levelCoord to be consistent with toRects?
    }
    ...
    var TimeCol = /** @class */ (function (_super) {
        ...
        TimeCol.prototype.render = function () {
            ...
            var mirrorSegs = (props.eventDrag && props.eventDrag.segs) ||
                ...
                [];
            var interactionAffectedInstances = // : messy way to compute this
             (props.eventDrag && props.eventDrag.affectedInstances) ||
                (props.eventResize && props.eventResize.affectedInstances) ||
                {};
    ...
    var DayTimeCols = /** @class */ (function (_super) {
        ...
        DayTimeCols.prototype.render = function () {
            ...
            // : would move this further down hierarchy, but sliceNowDate needs it
    ...
    var ListViewHeaderRow = /** @class */ (function (_super) {
        ...
        ListViewHeaderRow.prototype.render = function () {
            ...
            // : make a reusable HOC for dayHeader (used in daygrid/timegrid too)
    ...
    function buildTimeContent(seg, timeFormat, context, timeHeaderId, dateHeaderId) {
        ...
        if (options.displayEventTime !== false) {
            ...
            else if (isMultiDayRange(seg.eventRange.range)) { // : use (!isStart || !isEnd) instead?
                if (seg.isStart) {
    ...
    */
    ...
    BootstrapTheme.prototype.iconOverrideOption = 'bootstrapFontAwesome'; // : make TS-friendly. move the option-processing into this plugin
    ...
    var eventSourceDef = {
        ...
        fetch: function (arg, onSuccess, onFailure) {
            ...
            if (!apiKey) {
                ...
                // : make DRY with json-feed-event-source
